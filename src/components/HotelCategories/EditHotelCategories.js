...
const EditHotelCategories = () => {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    await axios.post(`http://127.0.0.1:8000/api/adHotel/update/${id}`, user).then((res)=>{
      swal("Success",res.data.message, "success");
      history.push("/adHotel/show");
    })
...
<h1 className="mb-5">Edit Hotel Categories</h1>
...
export default EditHotelCategories;
